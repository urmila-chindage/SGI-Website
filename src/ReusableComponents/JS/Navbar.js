            ...
            <ul>
              ...
              >
                ...
                <ul>
                  ...
                  <li>
                    <Link to="/about/aboutsgi" className="a">
                      About SG institute
                    </Link>
                  </li>
                  <li>
              ...
              >   
                ...
                <ul>
                  ...
                  <li>
                    <Link to="/department/mechanical" className="a">
                  ...
                  <li>
                    <Link to="/department/electronics" className="a">
                      E & TC
                    </Link>
                  </li>
                  <li>
              ...
              >
                <Link to="/admissionform" className="mainMenu">
                  Admissions
                </Link>
              </li>
              ...
              >
                ...
                <ul>
                  ...
                  <li>
                    <Link to="/facilities/classrooms" className="a">
                      Class rooms
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="/facilities/swimmingpool" className="a">
                      Swimming Pool
                    </Link>
                  </li>
                  <li>
                    <Link to="/facilities/auditorium" className="a">
                      Auditorium
                    </Link>
                  </li>
                  <li>
                    <Link to="/facilities/conferencehall" className="a">
                      Conference Hall
                    </Link>
                  </li>
                  {/* <li>
                  ...
                  <li>
                    <Link to="/facilities/cafeteria" className="a">
                      Cafeteria
                    </Link>
                  </li>
                  {/* <li>
                  ...
                  <li>
                    <Link to="/facilities/playingground" className="a">
                      Playing Ground
                    </Link>
                  </li>
                  <li>
                    <Link to="/facilities/tenniscourt" className="a">
                      Tennis Court
                    </Link>
                  </li>
                  <li>
