...
const Courses = () => {
  return (
    <>
      <div className="text-center pt-5 course-section">
        ...
        <div className="row text-center d-flex justify-content-center dept-section">
          ...
          <Link className="col-xl-2 col-sm-6 mb-5 dept-img shadow-lg m-2 mb-sm-3 mb-xl-2 rounded" to="/department/mech">
            <div>
              <img src={Mechanical}/>
              <div className="text p-4">
                <h4>Mechanical</h4>
          ...
          <Link className="col-xl-2 col-sm-6 mb-5 dept-img shadow-lg m-2 mb-sm-3 mb-xl-2 rounded" to="/department/entc">
            <div>
              <img src={Electronics}/>
              <div className="text p-4">
                <h4>E &amp; TC</h4>
